...
const Sidebar: React.FC<SidebarProps> = ({ open, setOpen }) => {
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 flex flex-col z-30 w-64 bg-white shadow-lg transform transition duration-300 ease-in-out md:relative md:translate-x-0 ${
      ...
      >
        ...
        <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `flex items-center px-2 py-2 text-sm font-medium rounded-md group transition-colors duration-150 ease-in-out ${
                isActive
