        ...
        <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
          ...
          {canSee('1', '99') && (
            <>
              ...
              <NavLink to="/student/subjects" className={({ isActive }) => `flex items-center px-2 py-2 text-sm font-medium rounded-md group transition-colors duration-150 ease-in-out ${isActive ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>
